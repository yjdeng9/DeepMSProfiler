...
def main():
    ...
    # 创建一个文件夹用于工作目录
    job_name = 'jobs007'
    job_dir = os.path.join(args.out_dir, job_name)
    ...
    # Step2 : select parameters
    run_train = args.run_train
    run_pred = args.run_pred
    run_feature = args.run_feature

    train_data, train_label, train_samples, test_data, test_label, test_samples = load_jobs_data(job_dir, num_classes=3)
